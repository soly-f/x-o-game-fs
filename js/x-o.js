...
const gameOver = gameWon => {
    for (let index of winCombos[gameWon.index]) {
        ...
        document.getElementById(index).style.backgroundColor = '#31AAAA';
    }
    ...
    declareWinner(gameWon.player === user ? "You Won The Game!" : "PC Won The Game!");
}
...
const checkTie = () => {
    ...
    if (emptySquares().length === 0) {
        ...
        for (let cell of cells) {
            cell.style.backgroundColor = " #9525b8";
            cell.removeEventListener('click', handleClick, false);
        }
